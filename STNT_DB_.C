 ...
 void main()
 {
   ...
   /* FOLLOWING CODE IS TO BEACKUP RECORDS */
 ...
 void login_window()
 {
  ...
  /* rectangle for password input */
   ...
   /* draws head for 4th body */
    ...
    /* following code is to draw the circle Enter Button */
    ...
    /* FOLLOWING IS CODE FOR INNER MOST RECTANGLE */
  ...
  if(ch==13)
  {
    ...
    {
    sound(99*i);
     /* following code is to draw the circle Enter Button to give press effect  */
    setcolor(WHITE);
    setfillstyle(1,12);
    circle(442,272,12);
    circle(442,272,11);
...
delay(19);
  ...
  /* FOLLOWING code IS TO ADD RECORD/MODIFY */
 ...
 void add_student_record()
  ...
  /* FOLLOWING CODE PRINTS THE INPUT BOX FOR SEARCH RECORD/DELETE/MODIFY RECORD */
 ...
 /* FOLLOWING CODE PRINTS THE INPUT BOX FOR SEARCH RECORD/DELETE/MODIFY RECORD */
    ...
    void modify_student_record()
   {
    ...
    /* FOLLOWING CODE PRINTS THE INPUT BOX FOR MODIFY RECORD */
  ...
  /* THE REMAINING COLUMN IS FOR MOBILE NO */
     ...
     void backup_database()
   {
    ...
    FILE *fp,*backup;
    fp=fopen("C:\\TURBOC3\\BIN\\DATABASE.DAT","rb+");
    ...
    backup=fopen("D:\\BACKUP.DAT","wb+");/* r+ because reads the existing content and write new contents */
  if(backup==NULL)
   {
    cleardevice();
    draw_screen();
